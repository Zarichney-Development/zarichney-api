...
1.  **Understand Task:** Review the GitHub Issue and task prompt thoroughly.
2.  **Review Context:** Consult relevant standards and local `README.md` files.
3.  **Branch:** Create a feature/test branch (`feature/issue-XXX-desc` or `test/issue-XXX-desc`).
4.  **Code/Test:** Implement changes and add/update tests.
...
8.  **Pull Request:** Create a PR using `gh pr create`.
...
* **Diagramming Rules:** [`/Docs/Standards/DiagrammingStandards.md`](../Docs/Standards/DiagrammingStandards.md)
...
* **Adhere to Boundaries:** Respect any "what *not* to change" instructions in the prompt.
