...
public class CustomerRepositoryTests
{
    ...
    public async Task GetCustomerByEmail_WithExistingCustomer_ReturnsCustomer()
    {
        ...
        _mockFileService
            .Setup(fs => fs.ReadFromFile<Customer?>(It.IsAny<string>(), It.IsAny<string>()))
        ...
        _mockFileService.Verify(
            fs => fs.ReadFromFile<Customer?>(It.IsAny<string>(), It.IsAny<string>()),
            Times.Once,
    ...
    public void SaveCustomer_WithValidCustomer_QueuesWrite()
    {
        ...
        _mockFileWriteQueueService.Verify(
            fwqs => fwqs.QueueWrite(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<Customer>()),
            Times.Once,
