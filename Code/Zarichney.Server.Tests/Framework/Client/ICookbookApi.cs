...
namespace Zarichney.Client
{
    ...
    public partial interface ICookbookApi
    {
        ...
        /// <summary>⚠️ (Unavailable: MailCheck (Missing: EmailConfig:MailCheckApiKey); MsGraph (Missing: EmailConfig:AzureTenantId, EmailConfig:AzureAppId, EmailConfig:AzureAppSecret)) Creates a new cookbook order based on user submission.</summary>
        /// <remarks>
        /// **This endpoint is currently unavailable** due to missing configuration for: MailCheck (Missing: EmailConfig:MailCheckApiKey); MsGraph (Missing: EmailConfig:AzureTenantId, EmailConfig:AzureAppId, EmailConfig:AzureAppSecret)
        /// 
