...
public static class MockHelper
{
    ...
    public static Mock<IOptions<T>> CreateMockOptions<T>(T configValue) where T : class
    {
    ...
    public static ControllerContext CreateTestControllerContext(
        string? contentType = null, 
        bool setupForm = true)
    {
    ...
    public static Task<T> SuccessTask<T>(T returnValue)
    {
    ...
    public static Task FailedTask(Exception exception)
    {
    ...
    /// <param name="exception">Exception to throw</param>
    /// <returns>Faulted task</returns>
    public static Task<T> FailedTask<T>(Exception exception)
    {
