...
* **Refit Client (`IZarichneyAPI`):** The auto-generated, type-safe HTTP client used for all API interactions in integration tests. Generated by `Scripts/GenerateApiClient.ps1`.
