...
public class UserDbContextFactory : IDesignTimeDbContextFactory<UserDbContext>
{
  public UserDbContext CreateDbContext(string[] args)
  {
    ...
    try
    {
      ...
      // e.g., Directory.GetCurrentDirectory() + "/Zarichney.Server.Auth" (replace with your project path)
    ...
    optionsBuilder.UseNpgsql(connectionString, options =>
        ...
        // If your DbContext and Migrations are in the same project/assembly (e.g., Zarichney.Server.Auth),
