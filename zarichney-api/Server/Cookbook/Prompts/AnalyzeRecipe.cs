    ...
    Parameters = JsonSerializer.Serialize(new
    {
      ...
      properties = new
      {
        qualityScore = new
        {
          type = "integer",
          description =
            "A score from 1 to 100 indicating the overall quality and alignment of the recipe with the cookbook order specifications"
        },
        analysis = new
        {
          type = "string",
          description =
            "A strict, critical evaluation of the recipe's alignment with the cookbook order and its overall quality"
        },
        suggestions = new
        {
          type = "string",
